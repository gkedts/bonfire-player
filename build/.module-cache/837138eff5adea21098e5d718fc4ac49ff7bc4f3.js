...
var Buttons = React.createClass({displayName: "Buttons",
  ...
  render: function () {
    ...
    if (this.props.state == "playing") {
      playbutton = React.createElement("div", {onClick: 
        () => this.props.mopidy.playback.pause()}, "▐▐");
    } else {
      playbutton = React.createElement("div", {onClick: 
        () => this.props.mopidy.playback.play()}, "▶");
    };  

    return React.createElement("div", {className: "play-pause-button"}, 
      React.createElement("div", {onClick: () => this.props.mopidy.playback.previous()}, "◀▐"), 
      playbutton, 
      React.createElement("div", {onClick: () => this.props.mopidy.playback.stop()}, "◼"), 
      React.createElement("div", {onClick: () => this.props.mopidy.playback.next()}, "▐▶")
    );
  },  
});
