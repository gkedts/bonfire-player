...
var Buttons = React.createClass({displayName: "Buttons",
  ...
  render: function () {
    ...
    if (this.props.state == "playing") {
      playbutton = React.createElement("div", {onClick: alert('Pause!')}, "▐▐");
    } else {
      playbutton = React.createElement("div", {onClick: alert('Play!')}, "▶");
    };  

    return React.createElement("div", {className: "play-pause-button"}, 
      React.createElement("div", {onClick: alert('Back!')}, "◀▐"), playbutton, React.createElement("div", {onClick: alert('Stop!')}, "◼"), React.createElement("div", {onClick: alert('Next!')}, "▐▶")
    );
  },  
});
